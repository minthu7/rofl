...
<%@ page contentType="text/html; charset=UTF-8" import="com.accenture.adf.businesstier.entity.Visitor"%>
						...
						<td>
							<div id="content">
								...
								<p align="center" style="font-family: calibri; color: #6666CC;">Please
									...
									Festival Event Registration System are subject to postponement
									and cancellation at any time. Please frequently check the site
									for latest events are ticket availability. While using this
									site, you agree to have read and accepted our terms of use and
									privacy policy.</p>
								<br />
